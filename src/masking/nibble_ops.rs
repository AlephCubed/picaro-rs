...
#[inline]
pub(crate) fn nibble_square_byte<const PX: u8>(byte: u8) -> u8 {
    nibble_op!(nibble_square::<PX>, byte)
}
...
/// Squares all the bytes individually in the given finite field.
#[inline]
pub(crate) fn nibble_mult_byte<const PX: u8>(a: u8, b: u8) -> u8 {
    nibble_op!(nibble_mult::<PX>, a, b)
}
